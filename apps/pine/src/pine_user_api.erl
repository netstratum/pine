...
init_api() ->
  ...
  mnesia:dirty_write(#api_handlers{function = <<"identity.user.getdetails">>,
                                   ...
                                   created_on = Now}),
  mnesia:dirty_write(#api_handlers{function = <<"identity.role.list">>,
                                   arguments = [page_no, page_size],
                                   handler = {?MODULE, listroles_api},
                                   created_on = Now}),
  mnesia:dirty_write(#api_handlers{function = <<"identity.user.lock">>,
                                   arguments = [id, comment],
                                   handler = {?MODULE, lockuser_api},
                                   created_on = Now}),
  mnesia:dirty_write(#api_handlers{function = <<"identity.user.unlock">>,
                                   arguments = [id, comment],
                                   handler = {?MODULE, unlockuser_api},
                                   created_on = Now}),
  mnesia:dirty_write(#api_handlers{function = <<"identity.user.retire">>,
                                   arguments = [id, comment],
